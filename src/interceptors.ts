...
export interface MandeInstanceWithInterceptors extends MandeInstance {
  onRequest(_context: { url: string; options: _OptionsMerged }): _MaybePromise<void>

  onResponse(_context: { url: string; options: _OptionsMerged; response: Response }): unknown
...
export function withInterceptors(mande: MandeInstance): MandeInstanceWithInterceptors {
